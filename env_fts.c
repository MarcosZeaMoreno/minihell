...
/*   Updated: 2024/04/23 21:53:43 by vkatason         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * @param key 		The pointer to the key.
 * @param value 	The pointer to the value.
 * @var env_v		The pointer to the enviromental variable.
 * @var key_copy	The pointer to the copy of the key.
 * @var value_copy	The pointer to the copy of the value.
 * @var aux			The pointer to the auxiliar variable.
 * @var temp		The pointer to the temp variable.
 * 
