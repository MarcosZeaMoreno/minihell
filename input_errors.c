 ...
 * This flag is toggled each time a single quote (') is encountered, 
 * unless a double quote is currently open (flags[1] is 1).
 * 
 ...
 * This flag is toggled each time a backslash (\) is encountered, 
 * unless a single quote is currently open (flags[0] is 1). 
