...
/*   Updated: 2024/04/23 21:39:26 by vkatason         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/**
 * @brief		Function checks if the given command 
 * 				is built-in command with a special use:
 * 				`cd`,
 * 				`export`,
 * 				`unset`.
 *
...
/**
 * @brief 		Function that executes a built-in command 
 * 				based on the given command array.
 *
 * @param data 	The main data structure 
 * 				that contains information about the shell.
