...
/*   Updated: 2024/02/12 21:24:34 by vkatason         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	print_tkn(t_tkn *tkn)
{
	const char	*tkn_types[] = {
		"TKN_WHITESPACE", "TKN_TAB", "TKN_NEWLINE", "TKN_DOT", "TKN_COMMA",
		"TKN_COLON", "TKN_SEMICOLON", "TKN_EXCLAMATION", "TKN_QUESTION",
		"TKN_SLASH", "TKN_BACKSLASH", "TKN_ASTERISK", "TKN_EQUALS",
		"TKN_MINUS", "TKN_PLUS", "TKN_PIPE", "TKN_DOUBLE_PIPE",
